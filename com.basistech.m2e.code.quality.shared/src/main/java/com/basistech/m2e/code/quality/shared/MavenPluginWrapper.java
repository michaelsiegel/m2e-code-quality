...
public class MavenPluginWrapper {
  public static MojoExecution findMojoExecution(IProgressMonitor monitor,
      ...
      final String pluginArtifactId, final String[] pluginGoal) throws CoreException {
    List<MojoExecution> mojoExecutions = mavenProjectFacade.getMojoExecutions(pluginGroupId,
  ...
  public static boolean mojoExecutionForPlugin(MojoExecution mojoExecution, String groupId,
  ...
  public static MavenPluginWrapper newInstance(IProgressMonitor monitor,
    ...
    final MojoExecution execution = findMojoExecution(monitor, mavenProjectFacade, pluginGroupId,
  ...
  private static MojoExecution searchExecutions(final String pluginGroupId,
      final String pluginArtifactId, final String[] pluginGoal, List<MojoExecution> mojoExecutions) {
  ...
  public List<Dependency> getDependenciesIncludingSelf() {
    ...
    dl.addAll(this.execution.getPlugin().getDependencies());
  ...
  private Dependency getPluginAsDependency() {
    ...
    d.setGroupId(this.execution.getPlugin().getGroupId());
    d.setArtifactId(this.execution.getPlugin().getArtifactId());
    d.setVersion(this.execution.getPlugin().getVersion());
